...
button.stream_mod:hover {
    opacity: 0.7;
}
button.stream_mod.back {
    margin-left: 6px;
}
...
div.swa-reactions-picker-container {
    ...
    function set() {
      ...
      //gainNode.gain.value = def_gain;
        ...
        btn_back30s.classList.add('stream_mod');
        btn_back30s.classList.add('back');
        ...
        btn_forward30s.classList.add('stream_mod');
        ...
        btn_back60s.classList.add('stream_mod');
        btn_back60s.classList.add('back');
        ...
        btn_forward60s.classList.add('stream_mod');
        ...
        btn_back10m.classList.add('stream_mod');
        btn_back10m.classList.add('back');
        ...
        btn_forward10m.classList.add('stream_mod');
